    ...
    return (
        <footer className='bg-[#F3F6Fa]'>
                ...
                <div className='w-3/12 lg:w-4/12 sm:w-full'>
                    <div className='flex flex-col gap-3'>
                        ...
                        <ul className='flex flex-col gap-2 text-slate-600'>
                            ...
                            <li>Phone : 9812345678</li>
                            <li>Email : sunil@gmail.com</li>
                        </ul>
                    </div>
                </div>
            ...
            <div className='w-[85%] flex flex-wrap justify-center items-center text-slate-600 mx-auto py-5 text-center'>
                <span>Copiright ©2023 All rights reserved | mady by <a className='text-blue-500 underline' href="">@Sunil</a></span>
            </div>
        </footer>
    )
}
